package com.logate.myapp.repository;

import com.logate.myapp.MyappApp;
import com.logate.myapp.config.Constants;
import com.logate.myapp.config.audit.AuditEventConverter;
import com.logate.myapp.domain.PersistentAuditEvent;
...
import static com.logate.myapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
